...
func GetConstraintsInput_ToDafny(nativeInput simpleconstraintstypes.GetConstraintsInput)(simpleconstraintsinternaldafnytypes.GetConstraintsInput) {
    ...
    return func () simpleconstraintsinternaldafnytypes.GetConstraintsInput {
        ...
        var v []interface{}
        if nativeInput.NonEmptyBlob == nil {return Wrappers.Companion_Option_.Create_None_()}
        ...
        var v []interface{}
        if nativeInput.BlobLessThanOrEqualToTen == nil {return Wrappers.Companion_Option_.Create_None_()}
        for _, e := range nativeInput.BlobLessThanOrEqualToTen {
        	v = append(v, e)
        }
        return Wrappers.Companion_Option_.Create_Some_(dafny.SeqOf(v...));
    }(),func () Wrappers.Option {
           if nativeInput.MyList == nil { return Wrappers.Companion_Option_.Create_None_() }
        ...
        return dafny.SeqOfChars([]dafny.Char(val)...)
           ...
           if nativeInput.NonEmptyList == nil { return Wrappers.Companion_Option_.Create_None_() }
           var fieldValue []interface{} = make([]interface{}, 0)
        ...
        return dafny.SeqOfChars([]dafny.Char(val)...)
           ...
           if nativeInput.ListLessThanOrEqualToTen == nil { return Wrappers.Companion_Option_.Create_None_() }
           var fieldValue []interface{} = make([]interface{}, 0)
        ...
        if nativeInput.MyMap == nil { return Wrappers.Companion_Option_.Create_None_() }
        ...
        if nativeInput.NonEmptyMap == nil { return Wrappers.Companion_Option_.Create_None_() }
    	   fieldValue := dafny.NewMapBuilder()
        ...
        if nativeInput.MapLessThanOrEqualToTen == nil { return Wrappers.Companion_Option_.Create_None_() }
    	   fieldValue := dafny.NewMapBuilder()
        ...
        if nativeInput.OneToTen == nil {return Wrappers.Companion_Option_.Create_None_()}
        return Wrappers.Companion_Option_.Create_Some_(*nativeInput.OneToTen)
    }(),func () Wrappers.Option {
        if nativeInput.MyTenToTen == nil {return Wrappers.Companion_Option_.Create_None_()}
        return Wrappers.Companion_Option_.Create_Some_(*nativeInput.MyTenToTen)
    }(),func () Wrappers.Option {
        if nativeInput.GreaterThanOne == nil {return Wrappers.Companion_Option_.Create_None_()}
        return Wrappers.Companion_Option_.Create_Some_(*nativeInput.GreaterThanOne)
    }(),func () Wrappers.Option {
        if nativeInput.LessThanTen == nil {return Wrappers.Companion_Option_.Create_None_()}
        return Wrappers.Companion_Option_.Create_Some_(*nativeInput.LessThanTen)
    }(),func () Wrappers.Option {
        if nativeInput.MyUtf8Bytes == nil {return Wrappers.Companion_Option_.Create_None_()}
        ...
        return f
           ...
           if nativeInput.MyListOfUtf8Bytes == nil { return Wrappers.Companion_Option_.Create_None_() }
           var fieldValue []interface{} = make([]interface{}, 0)
...
func GetConstraintsOutput_ToDafny(nativeOutput simpleconstraintstypes.GetConstraintsOutput)(simpleconstraintsinternaldafnytypes.GetConstraintsOutput) {
    ...
    return func () simpleconstraintsinternaldafnytypes.GetConstraintsOutput {
        ...
        if nativeOutput.MyString == nil {return Wrappers.Companion_Option_.Create_None_()}
        return Wrappers.Companion_Option_.Create_Some_(dafny.SeqOfChars([]dafny.Char(*nativeOutput.MyString)...))
    }(),func () Wrappers.Option {
        if nativeOutput.NonEmptyString == nil {return Wrappers.Companion_Option_.Create_None_()}
        return Wrappers.Companion_Option_.Create_Some_(dafny.SeqOfChars([]dafny.Char(*nativeOutput.NonEmptyString)...))
    }(),func () Wrappers.Option {
        if nativeOutput.StringLessThanOrEqualToTen == nil {return Wrappers.Companion_Option_.Create_None_()}
        return Wrappers.Companion_Option_.Create_Some_(dafny.SeqOfChars([]dafny.Char(*nativeOutput.StringLessThanOrEqualToTen)...))
    }(),func () Wrappers.Option {
        var v []interface{}
        if nativeOutput.MyBlob == nil {return Wrappers.Companion_Option_.Create_None_()}
        ...
        var v []interface{}
        if nativeOutput.NonEmptyBlob == nil {return Wrappers.Companion_Option_.Create_None_()}
        ...
        var v []interface{}
        if nativeOutput.BlobLessThanOrEqualToTen == nil {return Wrappers.Companion_Option_.Create_None_()}
        for _, e := range nativeOutput.BlobLessThanOrEqualToTen {
        	v = append(v, e)
        }
        return Wrappers.Companion_Option_.Create_Some_(dafny.SeqOf(v...));
    }(),func () Wrappers.Option {
           if nativeOutput.MyList == nil { return Wrappers.Companion_Option_.Create_None_() }
           var fieldValue []interface{} = make([]interface{}, 0)
        ...
        return dafny.SeqOfChars([]dafny.Char(val)...)
           ...
           if nativeOutput.NonEmptyList == nil { return Wrappers.Companion_Option_.Create_None_() }
           var fieldValue []interface{} = make([]interface{}, 0)
        ...
        return dafny.SeqOfChars([]dafny.Char(val)...)
           ...
           if nativeOutput.ListLessThanOrEqualToTen == nil { return Wrappers.Companion_Option_.Create_None_() }
           var fieldValue []interface{} = make([]interface{}, 0)
        ...
        if nativeOutput.MyMap == nil { return Wrappers.Companion_Option_.Create_None_() }
    	   fieldValue := dafny.NewMapBuilder()
        ...
        if nativeOutput.NonEmptyMap == nil { return Wrappers.Companion_Option_.Create_None_() }
    	   fieldValue := dafny.NewMapBuilder()
        ...
        if nativeOutput.MapLessThanOrEqualToTen == nil { return Wrappers.Companion_Option_.Create_None_() }
    	   fieldValue := dafny.NewMapBuilder()
        ...
        if nativeOutput.OneToTen == nil {return Wrappers.Companion_Option_.Create_None_()}
        return Wrappers.Companion_Option_.Create_Some_(*nativeOutput.OneToTen)
    }(),func () Wrappers.Option {
        if nativeOutput.ThatTenToTen == nil {return Wrappers.Companion_Option_.Create_None_()}
        return Wrappers.Companion_Option_.Create_Some_(*nativeOutput.ThatTenToTen)
    }(),func () Wrappers.Option {
        if nativeOutput.GreaterThanOne == nil {return Wrappers.Companion_Option_.Create_None_()}
        return Wrappers.Companion_Option_.Create_Some_(*nativeOutput.GreaterThanOne)
    }(),func () Wrappers.Option {
        if nativeOutput.LessThanTen == nil {return Wrappers.Companion_Option_.Create_None_()}
        return Wrappers.Companion_Option_.Create_Some_(*nativeOutput.LessThanTen)
    }(),func () Wrappers.Option {
        if nativeOutput.MyUtf8Bytes == nil {return Wrappers.Companion_Option_.Create_None_()}
        return Wrappers.Companion_Option_.Create_Some_(    dafny.SeqOf(func () []interface{} {
        ...
        return f
           ...
           if nativeOutput.MyListOfUtf8Bytes == nil { return Wrappers.Companion_Option_.Create_None_() }
           var fieldValue []interface{} = make([]interface{}, 0)
...
func SimpleConstraintsException_ToDafny(nativeInput simpleconstraintstypes.SimpleConstraintsException)(simpleconstraintsinternaldafnytypes.Error) {
    return func () simpleconstraintsinternaldafnytypes.Error {
        ...
        if nativeInput.Message == nil {return nil}
