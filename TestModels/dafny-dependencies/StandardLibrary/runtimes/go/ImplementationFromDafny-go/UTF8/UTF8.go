...
func (_static *CompanionStruct_Default___) IsASCIIString(s _dafny.Sequence) bool {
	...
	for _72_i := _dafny.Zero; _72_i.Cmp(_hi0) < 0; _72_i = _72_i.Plus(_dafny.One) {
		if !((_dafny.IntOfInt32(rune((s).Select((_72_i).Uint32()).(_dafny.Char)))).Cmp(_dafny.IntOfInt64(128)) < 0) {
			_hresult = false
			return _hresult
		}
	}
...
TAIL_CALL_START:
	if (_dafny.IntOfUint32((s).Cardinality())).Sign() == 0 {
		...
		var _74_x _dafny.Sequence = _dafny.SeqOf(uint8((s).Select(0).(_dafny.Char)))
		_ = _74_x
