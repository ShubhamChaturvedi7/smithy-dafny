...
func (_static *CompanionStruct_Default___) GetInteger(config Config, input simpletypesintegerinternaldafnytypes.GetIntegerInput) Wrappers.Result {
	...
	if !(((input).Dtor_value()).Is_Some()) {
		panic("src/SimpleIntegerImpl.dfy(20,8): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !(((((_dafny.Zero).Minus(StandardLibrary_UInt.Companion_Default___.INT32__MAX__LIMIT())).Int32()) <= (((input).Dtor_value()).UnwrapOr(int32(0)).(int32))) && ((((input).Dtor_value()).UnwrapOr(int32(0)).(int32)) <= (((StandardLibrary_UInt.Companion_Default___.INT32__MAX__LIMIT()).Minus(_dafny.One)).Int32()))) {
		panic("src/SimpleIntegerImpl.dfy(21,8): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _1_res simpletypesintegerinternaldafnytypes.GetIntegerOutput
	_ = _1_res
	_1_res = simpletypesintegerinternaldafnytypes.Companion_GetIntegerOutput_.Create_GetIntegerOutput_((input).Dtor_value())
...
func (_static *CompanionStruct_Default___) GetIntegerKnownValueTest(config Config, input simpletypesintegerinternaldafnytypes.GetIntegerInput) Wrappers.Result {
	...
	_ = output
	if !(((input).Dtor_value()).Is_Some()) {
		panic("src/SimpleIntegerImpl.dfy(27,8): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	if !((((input).Dtor_value()).UnwrapOr(int32(0)).(int32)) == (int32(20))) {
		panic("src/SimpleIntegerImpl.dfy(28,8): " + (_dafny.SeqOfString("expectation violation")).String())
	}
	var _2_res simpletypesintegerinternaldafnytypes.GetIntegerOutput
	_ = _2_res
	_2_res = simpletypesintegerinternaldafnytypes.Companion_GetIntegerOutput_.Create_GetIntegerOutput_((input).Dtor_value())
