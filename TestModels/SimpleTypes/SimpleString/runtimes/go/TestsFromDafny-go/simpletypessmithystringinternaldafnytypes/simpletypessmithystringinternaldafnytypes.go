...
func (_this GetStringInput) Get_() Data_GetStringInput_ {
...
func (_this GetStringInput) Is_GetStringInput() bool {
	_, ok := _this.Get_().(GetStringInput_GetStringInput)
	return ok
}
...
func (_this GetStringInput) Dtor_value() Wrappers.Option {
	return _this.Get_().(GetStringInput_GetStringInput).Value
}
...
func (_this GetStringInput) Equals(other GetStringInput) bool {
	...
	case GetStringInput_GetStringInput:
		{
			data2, ok := other.Get_().(GetStringInput_GetStringInput)
...
func (_this GetStringOutput) Get_() Data_GetStringOutput_ {
...
func (_this GetStringOutput) Is_GetStringOutput() bool {
	_, ok := _this.Get_().(GetStringOutput_GetStringOutput)
	return ok
}
...
func (_this GetStringOutput) Dtor_value() Wrappers.Option {
	return _this.Get_().(GetStringOutput_GetStringOutput).Value
}
...
func (_this GetStringOutput) Equals(other GetStringOutput) bool {
	...
	case GetStringOutput_GetStringOutput:
		{
			data2, ok := other.Get_().(GetStringOutput_GetStringOutput)
			return ok && data1.Value.Equals(data2.Value)
		}
	default:
		{
...
func (_this SimpleStringConfig) Get_() Data_SimpleStringConfig_ {
...
func (_this SimpleStringConfig) Is_SimpleStringConfig() bool {
	_, ok := _this.Get_().(SimpleStringConfig_SimpleStringConfig)
	return ok
}
...
func (_ CompanionStruct_SimpleStringConfig_) AllSingletonConstructors() _dafny.Iterator {
	...
	return func() (interface{}, bool) {
		...
		switch i {
		case 0:
			return Companion_SimpleStringConfig_.Create_SimpleStringConfig_(), true
		default:
			return SimpleStringConfig{}, false
		}
	}
}
...
func (_this SimpleStringConfig) Equals(other SimpleStringConfig) bool {
	...
	case SimpleStringConfig_SimpleStringConfig:
		{
			_, ok := other.Get_().(SimpleStringConfig_SimpleStringConfig)
			return ok
		}
	default:
		{
...
type ISimpleTypesStringClient interface {
	...
	GetStringKnownValue(input GetStringInput) Wrappers.Result
